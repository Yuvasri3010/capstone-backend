    ...
    const info = await transporter.sendMail({
      ...
      html: `  <div style="display: flex; justify-content: center; align-items: center; height: 80vh; width: 100vw; ">
            <div className="border" style="height: 300px; width: 400px; border: 3px solid black; padding: 10px; border-radius: 15px;">
                <h1 style="background-color: black; color: white; border: 3px solid black; border-radius: 15px 15px 0 0; display:flex;     align-items: center !important; margin:0px"><img style="width: 50px; padding: 5px; margin-left: 13px;" src="https://icon-park.com/imagefiles/mail_vector_icon_turquoise_blue.png" alt=""> 
                <span style="display:flex; padding-top: 11px;">Bulk Email Service</span>
                </h1>
                <h3>${subject}</h3>
                <hr>
